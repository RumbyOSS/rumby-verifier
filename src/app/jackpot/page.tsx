...
const Page = () => {
	...
	return (
		<div className="flex flex-col w-full">
			<div className="flex flex-col text-white">
                ...
                <span className="mt-[10px]">{`Here's how Rumby Jackpot works:`}</span>
                <ul style={{ listStyle: "decimal" }} className="[&>*]:ml-[30px] mt-[10px] space-y-[20px]">
                    ...
                    <li>{`If a player places multiple bets within the same game round, they will receive separate ticket ranges for each bet.`}</li>
                    <li>
                        {`Once more than one player joins a round, a timer is initiated. When the timer expires, the game state is locked on-chain, preventing any additional players from joining. A public seed is then determined by retrieving the block hash of a future Solana block, which acts as a random value that is both unpredictable and immutable, thereby ensuring fairness.`}
                    </li>
                    <li>
    ...
    return result;
                    ...
                    <li>
                        {`The jackpot is awarded to the player whose ticket ID matches the randomly generated number.`}
                    </li>
                    <li>
